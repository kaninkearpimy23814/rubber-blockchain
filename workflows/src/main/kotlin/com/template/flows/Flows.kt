...
//@StartableByService
//@InitiatingFlow
//class Flows (val sender: String,
//             val rubberType: String,
//             val volume : Int,
//             val price : Int,
//             val recipient: String) : FlowLogic<String>() {
//    companion object {
...
//        val myAccount = accountService.accountInfo(sender).single().state.data
//        val myKey = subFlow(NewKeyForAccount(myAccount.identifier.id)).owningKey
//        val targetAccount = accountService.accountInfo(recipient).single().state.data
//        val targetAcctAnonymousParty = subFlow(RequestKeyForAccount(targetAccount))
//
//        //generating State for transfer
//        progressTracker.currentStep = GENERATING_TRANSACTION
//        val output = RubberState(UUID.randomUUID(),AnonymousParty(myKey),rubberType,volume,price,targetAcctAnonymousParty)
...
//                .addCommand(RubberContract.Commands.Create(), listOf(targetAcctAnonymousParty.owningKey,myKey))
//
...
//                val keyStateMovedTo = tx.coreTransaction.outRefsOfType(RubberState::class.java).first().state.data.destination
//                keyStateMovedTo?.let {
...
//            if (accountInfo != null) {
//                subFlow(BroadcastToCarbonCopyReceiversFlow(accountInfo, recievedTx.coreTransaction.outRefsOfType(RubberState::class.java).first()))
//            }
//        }
//    }
//}
